...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextMeshPro.rectTransform, Mouse.current.position.ReadValue(), Camera.main))
            {
            ...
            if (m_isHoveringObject)
            {
                ...
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, Mouse.current.position.ReadValue(), Camera.main, true);
                if (charIndex != -1 && charIndex != m_lastCharIndex && (Keyboard.current.leftShiftKey.isPressed || Keyboard.current.rightShiftKey.isPressed))
                {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    RectTransformUtility.ScreenPointToWorldPointInRectangle(m_TextMeshPro.rectTransform, Mouse.current.position.ReadValue(), m_Camera, out worldPointInRectangle);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextMeshPro, Mouse.current.position.ReadValue(), Camera.main);
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    //Debug.Log("Mouse Position: " + Mouse.current.position.ReadValue().ToString("f3") + "  Word Position: " + wordPOS.ToString("f3"));
